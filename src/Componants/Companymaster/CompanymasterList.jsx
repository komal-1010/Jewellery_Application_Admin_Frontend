...
import TextSuggestState from "../../Textsuggestfield/TextSuggestState";
import {
  alphanumeric,
  INITIAL_STATE,
  onlydecimal,
      ...
      <main>
        <Grid container spacing={0} sx={{ marginBottom: 2 }}>
          <Grid item xs={12} sm={12}>
            {/* <h1 className="dash-title">Companymaster List</h1> */}
          </Grid>
        </Grid>
        <Grid
          container
        ...
        >
          ...
          <Grid item md={12} xs={12} sm={12}>
            <h2>Companymaster Table</h2>
            <CompanymasterListtbl/>
          </Grid>
